...
for targetdir in targetdirs:
    os.makedirs(f'{targetdir}/flow4b',exist_ok=True)
    os.makedirs(f'{targetdir}/maskb',exist_ok=True)
    if len(glob.glob(f'{targetdir}/flow4b/*.jpg'))>0:
        continue
    for bf in 'bf':
        lastimage = None
        linktoorigin = dict()
            ...
            if lastimage is not None:
                ...
                if 1:
                    ...
                    for _x1, _y1, _x2, _y2 in zip(x1, y1, x2, y2):
                        ...
                        if True or dist((_x1, _y1), (_x2, _y2)) >= 20:
                            data.append([_x1, _x2])
                            data.append([_y1, _y2])
                            data.append('r')
                    ...
                    plt.savefig(f'{targetdir}/flow4b/{basef}')
