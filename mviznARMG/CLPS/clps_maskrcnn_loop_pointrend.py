...
import sys
sys.path.insert(1, "/home/mvizn/Code/detectron2_repo/projects/PointRend")
import point_rend
import os
import time
Tstart=time.time()
...
cfg.merge_from_file("/home/mvizn/Code/detectron2_repo/projects/PointRend/configs/InstanceSegmentation/pointrend_rcnn_R_50_FPN_3x_coco.yaml")
#cfg.MODEL.WEIGHTS = '/mnt/NFSDIR/ARMG-Project-Data/CLPS/images_2020-08-18_model_pointrend/model_0009999.pth'
cfg.MODEL.WEIGHTS = '/mnt/NFSDIR/ARMG-Project-Data/CLPS/images_2020-08-18_model_pointrend/model_final.pth'
