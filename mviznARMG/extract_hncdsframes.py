...
os.makedirs('/mnt/NFSDIR/ARMG-Project-Data/HNCDS/hits_20191211b',exist_ok=True)
import re
if 0:
    for f in sorted(glob.glob('/mnt/NFSDIR/ARMG-Project-Data/HNCDS/captures/7110/photologs_raw/*/*/*.jpg')):
        DATE,TIME,CAM=re.match('/mnt/NFSDIR/ARMG-Project-Data/HNCDS/captures/7110/photologs_raw/([^/]*)/[^/]*/([^_]*)_([^_]*)_[^_]*.jpg',f).groups()
        ...
        if len(results)>0:
            shutil.copy(f, f'/mnt/NFSDIR/ARMG-Project-Data/HNCDS/hits_20191211b/{DATE}_{TIME}_{CAM}_0.jpg')
            print(f,'yes')
        else:
            print(f, 'no')
