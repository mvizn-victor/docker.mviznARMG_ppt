...
import cv2
import re
outd='/mnt/NFSDIR/ARMG-Project-Data/clps_pmnrs_retraining_out/pmnrs'
...
for f in natural_sort(glob.glob('/mnt/NFSDIR/ARMG-Project-Data/clps_pmnrs_retraining/*/pmnrs/*/*.mp4')):
    CRANE,DATE,BASE=re.match('/mnt/NFSDIR/ARMG-Project-Data/clps_pmnrs_retraining/(.*)/pmnrs/(.*)/(.*).mp4',f).groups()
