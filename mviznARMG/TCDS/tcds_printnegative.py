        ...
        for camname in camnames:
                        ...
                        for x in camscores[camname]:
                            if x in storedetection[camname]:
                                ...
                                if not detected[camname, corner]:
                                    ...
                                    makedirsimwrite(f'{PHOTOLOGDIRNAME}/x{_DATE}_{_TIME}_{camname}_{corner}.jpg', _frame_cpy)
            ...
            for result in results:
                ...
                if min(frame2.shape[:2])<=10 or frame2.shape[0]/frame2.shape[1]<=0.5:
                    print(camname,y2,frame2.'invalid frame2.shape')
                    res=['n',1]
                else:
                ...
                if SIZE!=45 or SIZE==45 and camname.startswith('t'):
                    ...
                    if len(camscores[camname][x])>=3:
                        ...
                        if x not in negstoredetection[camname]:
                            negstoredetection[camname][x]=[DATE,TIME,frame_cpy]                        
                else:
